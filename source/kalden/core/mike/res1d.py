...
* Keep an optional CRS value on the reader for downstream spatial helpers.
...
class Res1D:
    ...
    crs : str, int, or None, default None
        ...
        for example ``"EPSG:2056"`` or ``2056``. It is kept as metadata on the
        reader for downstream spatial helpers; this lightweight module does not
        build GeoDataFrames itself.
